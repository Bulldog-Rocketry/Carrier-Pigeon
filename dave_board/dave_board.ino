...
void loop() {
 ...
 if((accel1.acceleration.y > 20) && (accel2.acceleration.y > 20) && (accel3.acceleration.y > 20)){
    launched = true;
  }
  while(launched){
    ...
    myFile.print(temp1.temperature); myFile.print(" ");
    myFile.print(temp2.temperature); myFile.print(" "); myFile.print(temp3.temperature);
    myFile.print(" ");

    myFile.print(accel1.acceleration.x); myFile.print(" "); myFile.print(accel2.acceleration.x);
    myFile.print(" "); myFile.print(accel3.acceleration.x); myFile.print(" ");

    myFile.print(accel1.acceleration.z); myFile.print(" "); myFile.print(accel2.acceleration.z);
    myFile.print(" "); myFile.print(accel3.acceleration.z); myFile.print(" ");

    myFile.print(-accel1.acceleration.y); myFile.print(" "); myFile.print(-accel2.acceleration.y);
    myFile.print(" "); myFile.print(-accel3.acceleration.y); myFile.print(" ");

    myFile.print(gyro1.gyro.x); myFile.print(" "); myFile.print(gyro2.gyro.x);
    myFile.print(" "); myFile.print(gyro3.gyro.x); myFile.print(" ");

    myFile.print(gyro1.gyro.y); myFile.print(" "); myFile.print(gyro2.gyro.y);
    myFile.print(" "); myFile.print(gyro3.gyro.y); myFile.print(" ");

    myFile.print(gyro1.gyro.z); myFile.print(" "); myFile.print(gyro2.gyro.z);
    myFile.print(" "); myFile.print(gyro3.gyro.z); myFile.print(" ");

    myFile.print(mag.magnetic.x); myFile.print(" "); myFile.print(mag.magnetic.y);
    myFile.print(" "); myFile.print(mag.magnetic.z); myFile.print(" ");
    ...
    delayMicroseconds(100000); // 0.1 second delay
